...
const schema = yup.object({
    ...
    description: yup.string().required('Description is required').max(2000, 'Max 2000 characters'),
});
    ...
    return (
        <Box sx={{ display: 'flex', justifyContent: 'center' }}>
            <Paper elevation={3} sx={{ width: '100%', maxWidth: 720, p: { xs: 2, sm: 3 }, mt: { xs: 2, sm: 4 } }}>
                <Typography variant="h5" gutterBottom align="center">Create Blog</Typography>
